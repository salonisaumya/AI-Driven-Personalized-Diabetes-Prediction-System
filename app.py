...
def user_report():
    ...
    # Create a DataFrame with the correct order of feature names
    user_report_data = pd.DataFrame({
...
ax2 = sns.scatterplot(x=user_data['Age'], y=user_data['Pregnancies'], s=150, color=color)  # Changed 'age' to 'Age'
...
ax4 = sns.scatterplot(x=user_data['Age'], y=user_data['Glucose'], s=150, color=color)  # Use 'Age' and 'Glucose'
plt.xticks(np.arange(10, 100, 5))
